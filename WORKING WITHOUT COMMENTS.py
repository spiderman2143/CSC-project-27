...
profile_frame = tk.Frame(base, bg='white', bd=2) # NEW FRAME
...
# THE PROFILE BUTTON IS PROPERLY WIRED TO THE NEW FUNCTION HERE:
...
def show_profile_screen():
    # Switches to profile frame
    hide_all_frames()
    profile_frame.place(relx=0.5, rely=0.5, anchor='center')

    # Clears old data if clicked multiple times
    ...
    try:
        ...
        # PASSWORD (No show/hide button, just printed plainly as requested)
